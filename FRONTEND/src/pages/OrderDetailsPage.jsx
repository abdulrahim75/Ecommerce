      ...
      {!orderDetails ? (
        ...
        <div className="p-4 sm:p-6 rounded-lg border">
          ...
          <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
            ...
            <span className={`${orderDetails.isDelivered ? "bg-green-100 text-green-700" : "bg-yellow-100 text-yellow-700"} px-3 py-1 rounded-full text-sm font-medium mb-2`}>{orderDetails.isDelivered ? "Delivered" : "Pending Delivery"}
            </span>
            </div>
        </div>

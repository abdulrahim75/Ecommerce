...
import { IoMdClose } from 'react-icons/io'; // Import IoMdClose
                ...
                <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button onClick={toggleCartDrawer} className="relative hover:text-black">
                            ...
                            {cartItemCount > 0 && (
                                <span className="absolute -top-1 bg-ecom-red text-white text-xs rounded-full px-2 py-0.5">{cartItemCount}</span>
                            )}
                        </button>
                        {/* Search */}
